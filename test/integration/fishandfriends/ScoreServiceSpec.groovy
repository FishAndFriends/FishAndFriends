...
class ScoreServiceSpec extends IntegrationSpec {
    ...
    void setup(){
        ...
        fishingArea = new FishingArea(name: "P�che aux canards", location: "le parc d'attraction", description: "M�me bourr�, on peut p�cher !")
    ...
    void "test score for a fishingMan"() {
        when: "je r�cup�re les scores de peche"
