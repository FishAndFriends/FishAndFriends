...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        if (FishingMan.count() == 0) {
            ...
            //Catch
            catchList << new Catch(date: new Date(year: 102, month: 10, date: 25), weight: 94.5,
                    size: 66.9, fish: fishList.get(0),
                    fishingMan: fishingManList.get(0),
                    fishingArea: fishingAreaList.get(0))

            catchList << new Catch(date: new Date(year: 110, month: 4, date: 7), weight: 660.5,
                    size: 99.9, fish: fishList.get(4),
                    fishingMan: fishingManList.get(1),
                    fishingArea: fishingAreaList.get(1))

            catchList << new Catch(date: new Date(year: 111, month: 3, date: 9), weight: 7.5,
                    size: 15.3, fish: fishList.get(1),
                    fishingMan: fishingManList.get(1),
                    fishingArea: fishingAreaList.get(1))
